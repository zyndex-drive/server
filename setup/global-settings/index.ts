...
import { globalSettingSchema } from '@typs/models/global-settings';

const IDPREFIX = 'globals@';

export const user_requests = (
  flag: boolean,
): Readonly<globalSettingSchema> => ({
  _id: `${IDPREFIX}001`,
...
export const tmdb_flag = (flag: boolean): Readonly<globalSettingSchema> => ({
  _id: `${IDPREFIX}003`,
...
export const mailing = (flag: boolean): Readonly<globalSettingSchema> => ({
  _id: `${IDPREFIX}004`,
  name: 'Allow Mailing',
