...
export const smtp_provider_add: Readonly<policySchema> = {
  _id: `${IDPREFIX}0001`,
...
export const smtp_provider_edit: Readonly<policySchema> = {
  _id: `${IDPREFIX}0002`,
...
export const smtp_provider_rm: Readonly<policySchema> = {
  _id: `${IDPREFIX}0003`,
